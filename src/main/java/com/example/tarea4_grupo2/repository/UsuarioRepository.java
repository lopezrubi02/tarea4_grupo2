...
public interface UsuarioRepository extends JpaRepository<Usuario, Integer> {
    ...
    @Query(value= "insert into usuarios (idusuario, nombre, apellidos, email, contraseniaHash,telefono,fechaNacimiento,sexo,dni,rol) " +
    ...
    @Query(value= "insert into usuarios (nombre, apellidos, email, contraseniaHash,telefono,fechaNacimiento,sexo,dni,rol) " +
            "values(?1,?2,?3,sha2(?4,256),?5,?6,?7,?8,?9);",nativeQuery = true)
    Usuario nuevoCliente(String nombre, String apellido, String email, String contra, int telefono,
                         Date fecha, String sexo, String dni, String rol);
